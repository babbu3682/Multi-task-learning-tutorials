...
# # sklearn
# tn, fp, fn, tp = confusion_matrix(y_true=cls_gt, y_pred=cls_pred.round()).ravel() # Only binary case, must y_pred and y_true be [0, 1, 0, 1]
# f1  = metrics.f1_score(tp, fp, fn, tn, reduction="macro")
# acc = metrics.accuracy(tp, fp, fn, tn, reduction="macro")
# sen = metrics.sensitivity(tp, fp, fn, tn, reduction="macro")
# spe = metrics.specificity(tp, fp, fn, tn, reduction="macro")
# print("check 2 == ", f1, acc, sen, spe)